...
print("1 - загрузить данные только по нативным токенам") #меняем имя csv в 23 строке
print("2 - загрузить данные только по стейблкоинам") #меняем имя csv в 30 строке
print("3 - загрузить данные по всем токенам") #меняем имя csv в 38 и 41 строке
